                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="product-gallery default">
                                    <img class="zoom-img" id="img-product-zoom" src="{{url("img/product/$product->url")}}" data-zoom-image="assets/img/product/13351544.jpg" width="411" />

                                    <div id="gallery_01f" style="width:500px;float:left;">
                                        <ul class="gallery-items">
                                           <li>
                                               <img src="{{url("img/product/$product->url")}}" alt="">
                                           </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="price-product defualt">
                                    <div class="price-value">
                                        <div class="price">
                                            ...
                                            <p><span>{{ $product->price }}<span>تومان</span></span></p>
